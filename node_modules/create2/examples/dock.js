...
function main(r) {
	...
	robot.showText("Hello VVorld", 500, true);
	...
	poto = function () {
		robot.showText("Pochina Linda <3", 500);
		robot.driveSpeed(robot.data.dropLeft?0:100,robot.data.dropRight?0:100); //Enable motors if wheels are up.
	}
	stop = function () {
		robot.driveSpeed(robot.data.dropLeft?0:0,robot.data.dropRight?0:0); //Enable motors if wheels are up.
	}
